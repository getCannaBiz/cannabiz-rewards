 ...
 * @subpackage CannaBiz_Rewards/public
 */
...
class CannaBiz_Rewards_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in CannaBiz_Rewards_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The CannaBiz_Rewards_Loader will then create the relationship
